...
class PDO:
    ...
    """Classe para ser usado para a conexao no banco. NAO USAR DIRETAMENTE EM CODIGOS COM O USUARIO DEVE SER ADICIONADO VALIDAÇOES
    CONTEM:
    delete
    ...
    async def init(self):
        """Instancia os metodos da classe pyodoc e realmente iniciar a conexao com o SQLSERVER
        """
    ...
    async def query(self, query: str, *args):
        ...
        Returns:
            dic: Retorna um dicionario em python com o seguinte formato coluna:valor 
        """
        try:
            # Executa a consulta
    ...
    async def getColunas(self, tabel:str):
        ...
        Args:
            tabel (str): Sua tabela que deseja saber as colunas
