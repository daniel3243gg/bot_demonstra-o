...
class EmailsFacil():
    ...
    @classmethod
    async def setInfoLogin(
        cls, smtpServer='smtp.gmail.com', smtpPort=587,
        smtpUseremail='email@gmail.com', smtpSenha='sndmsjdsds'
    ):
        ...
        try:
            ...
            for desti in cls.destinatarios:
                for _ in range(qnt):
                    ...
                    server.sendmail(
                        cls.smtpUseremail, desti, cls.message.as_string()
                    )
            server.quit()
...
async def main():
    ...
    await email.setInfoLogin(
        'smtp.gmail.com',587,'daniew600brandao@gmail.com','baxv ejvg rqsw cosi'
    )

    await email.setInfoDest(
        ['daniew600@gmail.com', 'juninho642.cp@gmail.com'], 'OLA MUNDO'
    )

    await email.setTemplate("""
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="container">
            ...
            <p>Olá [Nome],</p>
            <p>
            Estamos muito felizes em tê-lo(a) conosco. Esperamos que você
            desfrute da sua experiência e encontre valor em nossa plataforma.
            </p>
            <p>
            Fique à vontade para explorar e descobrir todas as funcionalidades
            que oferecemos.
            </p>
            <p>
